...
{
    public static class AssetManagementPlatformEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AssetManagementPlatformModuleExtensionConfigurator CLASS (in the Domain.Shared project)
