...
namespace SY.Airport.AssetManagementPlatform.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AssetManagementPlatformDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AssetManagementPlatformEfCoreEntityExtensionMappings to extend the IdentityUser entity
